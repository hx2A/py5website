...
BLOG_AUTHOR = "Jim Schmitz"  # (translatable)
BLOG_TITLE = "py5"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://py5.ixora.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://py5.ixora.io/"
BLOG_EMAIL = "jim@ixora.io"
BLOG_DESCRIPTION = "py5: processing for python 3.8+"  # (translatable)
...
CATEGORY_ALLOW_HIERARCHIES = True  # False
...
CATEGORY_DESTPATH_AS_DEFAULT = True  # False
...
CATEGORY_PAGES_FOLLOW_DESTPATH = True  # False
...
FAVICONS = (
    ("icon", "/images/main/logo_16x16.png", "16x16"),
    ("icon", "/images/main/logo_32x32.png", "32x32"),
    ("icon", "/images/main/logo_64x64.png", "64x64"),
#     ("icon", "/favicon.ico", "16x16"),
#     ("icon", "/icon_128x128.png", "128x128"),
)

# Show teasers (instead of full posts) in indexes? Defaults to False.
INDEX_TEASERS = True  # False
...
INDEX_READ_MORE_LINK = '<p class="more"><a href="{link}">{read_more}read more…</a></p>'
...
GLOBAL_CONTEXT = {
    ...
    # "filter_fix_image_link": filter_fix_image_link
}
