.. title: size()
.. slug: size
.. date: 2021-02-28 03:16:33 UTC+00:00
.. tags:
.. category:
.. link:
...
To run a sketch at the full dimensions of a screen, use the ``full_screen()`` function, rather than the older way of using ``size(display_width, display_height)``.
...
Updated on February 28, 2021 03:16:33am UTC
