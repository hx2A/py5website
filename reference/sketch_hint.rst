.. title: hint()
.. slug: hint
.. date: 2021-02-25 18:00:09 UTC+00:00
.. tags:
.. category:
.. link:
...
* ``ENABLE_STROKE_PURE``: Fixes a problem with shapes that have a stroke and are rendered using small steps (for instance, using ``vertex()`` with points that are close to one another), or are drawn at small sizes.
...
Updated on February 25, 2021 18:00:09pm UTC
