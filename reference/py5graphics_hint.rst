...
.. category:
.. link:
.. description: py5 Py5Graphics.hint() documentation
.. type: text
...
This method is the same as :doc:`hint` but linked to a ``Py5Graphics`` object. To see example code for how it can be used, see :doc:`hint`.
